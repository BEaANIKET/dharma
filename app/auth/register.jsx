        ...
        >
          ...
          >
            ...
            <View className="items-center">
              ...
              <Text className="mt-6 text-primary text-2xl tracking-widest">CREATE ACCOUNT</Text>
              <Text className="mt-3 text-textSecondary text-center px-6">
                Start your spiritual growth with Dharma AI
              </Text>
            </View>

            <GlassCard>
              <Text className="text-textSecondary mb-2">Full Name</Text>
              <TextInput
              ...
              <Text className="text-textSecondary mt-5 mb-2">Email</Text>
              <TextInput
            ...
            <AnimatedPressable onPress={() => router.push("/auth/login")} className="mt-1">
